...
var primaryColor   = '#2196f3';// getComputedStyle(document.body).getPropertyValue('--primary');
var secondaryColor = '#dde4eb';// getComputedStyle(document.body).getPropertyValue('--secondary');
var successColor   = '#19d895';// getComputedStyle(document.body).getPropertyValue('--success');
var warningColor   = '#ffaf00';// getComputedStyle(document.body).getPropertyValue('--warning');
var dangerColor    = '#ff6258';// getComputedStyle(document.body).getPropertyValue('--danger');
var infoColor      = '#8862e0';// getComputedStyle(document.body).getPropertyValue('--info');
var darkColor      = '#252C46';// getComputedStyle(document.body).getPropertyValue('--dark');
var lightColor     = '#fbfbfb';// getComputedStyle(document.body).getPropertyValue('--light');
...
(function ($) {
	...
	$(
		function () {
			...
			$( ".email-wrapper .mail-back-button" ).on(
				"click",
				function () {
	...
	$( ".sidebar .sidebar-inner > .nav > .nav-item" ).on(
		'click',
		function () {
