 ...
 */
class Advanced_Visit_Counter_Loader {
	 ...
	 *
	 * @var    array $shortcodes The shortcodes registered with WordPress to
	 ...
	 *                              $component.
	 * @param int    $priority      Optional. The priority at which the function should
	 *                              be fired. Default is 10.
	 ...
	 *
	 * @param string $hook          The name of the WordPress shortcode that is being
	 *                              registered.
	 * @param object $component     A reference to the instance of the object on
	 *                              which the shortcode is defined.
	 * @param string $callback      The name of the function definition on the
	 *                              $component.
	 * @param int    $priority      Optional. The priority at which the function should
	 *                              be fired. Default is 10.
